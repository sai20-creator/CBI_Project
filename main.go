...
func init() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/organic-cat-424921-c7:us-central1:mypostgres sslmode=disable port = 5432"
...
func GetTaxiTrips(db *sql.DB) {
	...
	geocoder.ApiKey = "AIzaSyBSzYYMCGD8Z6xLImd7xHw3kMZ1P_IYeVI"
...
func GetCCVIDetails(db *sql.DB) {
	...
	fmt.Println("CCVI Details: Received data from SODA REST API for CCVI")
